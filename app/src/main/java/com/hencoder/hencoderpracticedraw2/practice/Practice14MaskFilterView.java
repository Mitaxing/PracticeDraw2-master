...
public class Practice14MaskFilterView extends View {
    ...
    MaskFilter normalBlurMaskFilter, innerBlurMaskFilter, outerBlurMaskFilter, solodBlurMaskFilter;
...

    {
        ...
        solodBlurMaskFilter = new BlurMaskFilter(50, BlurMaskFilter.Blur.SOLID);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第四个：SOLID
        paint.setMaskFilter(solodBlurMaskFilter);
